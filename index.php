...
<body>
    ...
    <main>
        <div class="container">
            <?php
            /**for ($i = 0; $i < count($domandaRisposta); $i++) {
                echo ("<h1>" . $domandaRisposta[$i][0] . "<h1>");
                for ($j = 0; $j < count($domandaRisposta[$i][1]); $j++) {
                    echo ("<p>" . $domandaRisposta[$i][1] . "</p>");
                }
            }; */

            foreach ($domandaRisposta as $h2) {
                echo ("<h2>" . $h2 . "</h2>");
                foreach ($h2 as $paragrafo) {
                    echo ("<p>" . $paragrafo . "</p>");
                }
            }
            ?>
